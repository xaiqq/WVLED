...
from utils.general import colorstr, LOGGER, emojis

PREFIX = colorstr('AutoAnchor: ')

def check_anchor_order(m):
    # Check anchor order against stride order for WVLED Detect() module m, and correct if necessary
...
def kmean_anchors(dataset='', n=9, img_size=224, thr=4.0, gen=1000, verbose=True):
